...
public class BoardController {
    ...
    public ResponseEntity<ResponseBoard> getBoardById(@PathVariable String writer){

        BoardDto boardDto = boardService.getBoardById(writer);

        ResponseBoard responseBoard = new ModelMapper().map(boardDto, ResponseBoard.class);
